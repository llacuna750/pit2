        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
                <div>
                    ...
                    <p class="text-gray-600 dark:text-gray-400 mt-2">Manage your course catalog</p>
                </div>
            ...
            <!-- Search Section -->
            <div class="mb-8">
                <form method="GET" action="{{ route('courses.index') }}" class="relative max-w-md">
            ...
            <div class="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 
                           border-l-4 border-green-500 p-4 rounded-lg mb-6 shadow-sm">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right">
                                    <div class="flex items-center justify-end gap-3">
                                        ...
                                        <form action="{{ route('courses.destroy', $course->id) }}" method="POST"
                                            class="inline-block" onsubmit="return confirm('Are you sure you want to delete this course?')">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
